...
impl Module {
    pub fn activate(
        ...
        if arbos_version_for_gas > 0 {
            ...
            eprintln!("PROVER_DIAG: gas_in={} gas_out={} total_charged={} funcs={} data={} elems={} mem={} code={} wasm_len={} arbos_ver={}",
                gas_before_charges, *gas, gas_before_charges - *gas,
                funcs, data, elems, mem, code, wasm.len(), arbos_version_for_gas);
        }
