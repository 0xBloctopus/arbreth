...
- **Bugs**: Open a [GitHub issue](https://github.com/0xBloctopus/arbreth/issues) with reproduction steps
- **Security vulnerabilities**: See [SECURITY.md](https://github.com/0xBloctopus/arbreth/blob/master/SECURITY.md) - do not file a public issue

## License

By contributing, you agree that your contributions will be licensed under the [Business Source License 1.1](https://github.com/0xBloctopus/arbreth/blob/master/LICENSE.md).
