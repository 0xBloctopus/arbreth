...
/// Deterministic L2 EOA secret key used by the fixture filler.
pub fn dev_signing_key() -> B256 {
    keccak256(DEV_KEY_LABEL)
}

/// Returns the EOA address derived from `dev_signing_key`.
...
/// Verify an L1Message round-trips through `parse_incoming_l1_message`.
